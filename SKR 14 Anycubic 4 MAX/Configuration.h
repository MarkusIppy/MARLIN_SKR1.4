...
#define CUSTOM_MACHINE_NAME "4Max Ready"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //#define PID_BED_DEBUG // Sends debug data to the serial port.
   ...
   //MagiDeal 230V 750W Silicone Heatbed from Amazon with SSR-25

	#define DEFAULT_bedKp 49.65
	#define DEFAULT_bedKi 9.65
	#define DEFAULT_bedKd 170.29
